...
/* harmony export */ });
/* harmony import */ var _comment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19);
/* harmony import */ var _count_comments_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20);
...
const displayComments = async () => {
  ...
  const comments = await (0,_comment_js__WEBPACK_IMPORTED_MODULE_0__.getComments)(commentSection.dataset.id);
  commentSection.innerHTML = '';
  commentSection.innerHTML += `
      <h3>Comments ${(0,_count_comments_js__WEBPACK_IMPORTED_MODULE_1__["default"])(comments)}</h3>
...
/* harmony import */ var _modules_movieList_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
/* harmony import */ var _assets_rate_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
/* harmony import */ var _assets_love_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(15);
/* harmony import */ var _modules_likes_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16);
/* harmony import */ var _modules_count_movies_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(18);
/* harmony import */ var _modules_comment_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(19);
...
const addComment = async () => {
  ...
  form.addEventListener('submit', async (event) => {
    ...
    await (0,_modules_comment_js__WEBPACK_IMPORTED_MODULE_9__.postComment)(record);
    await (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_8__.displayComments)();
  });
};
...
const displayMovies = async () => {
  ...
  movieCount.innerHTML = (0,_modules_count_movies_js__WEBPACK_IMPORTED_MODULE_7__["default"])(movies);
  ...
  moviesSection.addEventListener('click', async (e) => {
    if (e.target.classList.contains('movie-btn')) {
      await (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_8__.createModal)(movies, e.target.dataset.id);
      await (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_8__.displayComments)();
      await addComment();
